...
// initial board (padded top and bottom) -- 5 reels x 6 = 4 VISIBLE rows + 2 padding.
// BOARD_DIMENSIONS below derives the visible board from this literal, so this is what
// actually sets the 5x4 grid -- config.numRows is NOT read anywhere in the app.
// Taken from a real Starwake book so it cannot disagree with the math.
